...
export const id: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "Mengarsipkan {count} thread",
    ...
    runFailedReason: "Run gagal: {reason}",
    runErrorTimedOut: "Waktu habis",
    runErrorUnknown: "Kesalahan tidak diketahui",
    attentionRequired: "Sesi perlu perhatian",
    model: "Model",
    provider: "Penyedia",
    runtime: "Runtime",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Notifikasi dinonaktifkan untuk OpenClaw di macOS. Izinkan melalui Pengaturan Sistem > Notifikasi.",
    },
    appearance: {
      theme: "Tema",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelAuth: "Autentikasi {channel} menurun — tanyakan pada saya apa yang terjadi",
      channelDisconnected: "{channel} baru saja terputus — tanyakan pada saya apa yang terjadi",
      channelDegraded: "{channel} sedang menurun — tanyakan pada saya apa yang terjadi",
  ...
  labsPage: {
    intro:
      "Labs berisi kemampuan eksperimental yang mungkin berubah, rusak, atau menghilang antar rilis.",
    sectionTitle: "Fitur eksperimental",
    sectionDescription: "Perubahan tersimpan seketika dan berlaku untuk eksekusi agen berikutnya.",
  ...
  chat: {
    ...
    messages: {
      ...
      forkUnavailable: "Bercabang tidak tersedia saat agen sedang bekerja",
