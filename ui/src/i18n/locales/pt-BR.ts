...
export const pt_BR: TranslationMap = {
  ...
  sessionsView: {
    ...
    invalidEmojiIcon: "Digite exatamente um emoji.",
  ...
  subtitles: {
    ...
    security: "Autenticação do Gateway, política de execução, perfil de ferramenta e aprovações.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelAuth: "Autenticação do {channel} degradada — pergunte-me o que aconteceu",
      channelDisconnected: "{channel} acabou de desconectar — pergunte-me o que aconteceu",
  ...
  appsPage: {
    ...
    badgeBundledIos: "Incluído no app do iOS",
    badgeBundledAndroid: "Incluído no app do Android",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Seu telefone Android como um nó OpenClaw completo — chat, câmera e Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      macos: {
        title: "macOS",
        desc: "Companheiro da barra de menus para seu Gateway — notificações, aprovações, chat rápido.",
      },
      windows: {
        title: "Windows",
  ...
  board: {
    ...
    widget: {
      ...
      errorDetail: "O problema está limitado a este cartão.",
  ...
  chat: {
    ...
    board: {
      ...
      dockMenu: "Painel de chat: {dock}",
      dockLeft: "Fixar chat à esquerda",
      dockRight: "Fixar chat à direita",
      dockBottom: "Fixar chat na parte inferior",
      dockHidden: "Ocultar chat",
      resizeDock: "Redimensionar painel de chat",
      reopenChat: "Mostrar chat",
      mockPlaceholder: "Junção de visualização do quadro · {tabs} abas · {widgets} widgets",
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "Ocultar esta mensagem neste navegador? O agente continua vendo-a.",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "As alterações são aplicadas quando você iniciar sua próxima sessão de Talk.",
