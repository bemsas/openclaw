...
export const vi: TranslationMap = {
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Dashboard khả dụng",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Thông báo bị tắt cho OpenClaw trong macOS. Cho phép chúng trong System Settings > Notifications.",
    },
    appearance: {
      theme: "Giao diện",
  ...
  mcpServers: {
    ...
    nameTaken: "Đã tồn tại máy chủ MCP có tên “{name}”.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép agent kết hợp các công cụ trong các quy trình JavaScript gọn nhẹ, được cô lập.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính để bàn và trình duyệt của bạn — cùng các plugin để mở rộng khả năng của agent.",
    ...
    sectionDesktop: "Trên máy tính để bàn của bạn",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Trò chuyện nhanh và trả lời nhanh ngay trên cổ tay bạn.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    widget: {
      ...
      allow: "Cho phép",
      reject: "Từ chối",
      rejected: "Đã từ chối quyền truy cập",
      ...
      actionErrorDetail: "Bảng điều khiển giữ lại trạng thái widget trước đó.",
  ...
  chat: {
    ...
    board: {
      ...
      dockBottom: "Gắn trò chuyện phía dưới",
