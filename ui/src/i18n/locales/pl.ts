...
export const pl: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Powiadomienia dla OpenClaw są wyłączone w macOS. Włącz je w Ustawieniach systemowych > Powiadomienia.",
    },
    appearance: {
      theme: "Motyw",
  ...
  custodian: {
    ...
    connectionChanged:
      "Połączenie z Gateway zmieniło się. Spróbuj ponownie, aby kontynuować tę konfigurację.",
    unsupportedGateway: "Zaktualizuj Gateway, aby kontynuować konfigurację z OpenClaw.",
    nudge: {
      configReload: "Ponowne wczytywanie konfiguracji zatrzymane — zapytaj mnie, co się stało",
  ...
  mcpServers: {
    ...
    connectRequired: "Połącz z gateway, aby zmienić serwery MCP.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Zmiany są zapisywane natychmiast i mają zastosowanie do przyszłych uruchomień agenta.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Podręczne czaty i szybkie odpowiedzi prosto z nadgarstka.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  chat: {
    ...
    board: {
      ...
      resetTitle: "Zresetować konwersację?",
      resetDescription:
        "Kontekst konwersacji zostanie zresetowany. Twój pulpit pozostanie bez zmian.",
    },
    catalog: {
