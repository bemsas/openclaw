...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Доступна панель",
    ...
    lastActive: "Востаннє активний {time}",
    surface: "Поверхня",
    subject: "Тема",
    room: "Кімната",
    space: "Простір",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Сповіщення вимкнено для OpenClaw у macOS. Дозвольте їх у Системних налаштуваннях > Сповіщення.",
    },
    appearance: {
      theme: "Тема",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Дозвольте Code Mode паралельно оркеструвати групи субагентів.",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    ...
    heroTagline:
      "Супутні застосунки для вашого телефона, годинника, комп’ютера та браузера — а також плагіни, що розширюють можливості вашого агента.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся, говоріть, підтверджуйте дії та діліться контентом в OpenClaw з iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкий перегляд чатів і швидкі відповіді просто із зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      linux: {
        title: "Linux",
        desc: "Нативний застосунок для комп'ютера — збірки .deb та AppImage.",
      },
      chrome: {
  ...
  chat: {
    ...
    composer: {
      ...
      switchCamera: "Переключити камеру",
