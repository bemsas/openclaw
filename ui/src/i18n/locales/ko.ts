...
export const ko: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "보관된 스레드 {count}개와 해당 대화 기록을 삭제할까요?",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelAuth: "{channel} 인증 저하됨 — 무슨 일이 있었는지 물어보세요",
  ...
  mcpServers: {
    ...
    nameTaken: "“{name}” 이름의 MCP 서버가 이미 있습니다.",
  ...
  labsPage: {
    intro:
      "Labs에는 릴리스마다 변경되거나 중단되거나 사라질 수 있는 실험적 기능이 포함되어 있습니다.",
    sectionTitle: "실험적 기능",
    sectionDescription: "변경 사항은 즉시 저장되며 이후 에이전트 실행에 적용됩니다.",
    documentation: "문서",
    restartRequired: "Gateway 재시작이 필요합니다.",
    saveErrorTitle: "기능을 업데이트할 수 없습니다",
    saveFailed: "기능 설정을 저장할 수 없습니다.",
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 간결하고 샌드박스화된 JavaScript 워크플로에서 도구를 조합하도록 합니다.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode가 여러 서브에이전트 그룹을 병렬로 조율하도록 합니다.",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 워치, 데스크톱, 브라우저용 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인.",
    sectionMobile: "휴대폰에서",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Gateway를 위한 메뉴 막대 동반 앱 — 알림, 승인, 빠른 채팅.",
      },
      windows: {
        title: "Windows",
        desc: "Windows 동반 앱은 PC를 OpenClaw 노드로 연결합니다.",
      },
      linux: {
        title: "Linux",
