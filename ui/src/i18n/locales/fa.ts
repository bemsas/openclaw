...
export const fa: TranslationMap = {
  ...
  configView: {
    ...
    syncedHint: "از طریق gateway در دستگاه‌های شما همگام‌سازی شده است.",
    notifications: {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} دچار افت کیفیت شده — از من بپرسید چه اتفاقی افتاده",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "به عامل‌ها اجازه دهید ابزارها را در جریان‌های کاری فشرده و سندباکس‌شده JavaScript ترکیب کنند.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ...
      windows: {
        title: "Windows",
        desc: "همراه ویندوز رایانه شما را به‌عنوان یک نود OpenClaw متصل می‌کند.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        title: "افزونه Chrome",
        desc: "به OpenClaw اجازه دهید Chrome موجود شما را هدایت کند — تب‌ها، صفحه‌ها و فرم‌ها.",
      },
      plugins: {
  ...
  board: {
    label: "داشبورد رشته",
    tabsLabel: "تب‌های داشبورد",
    moreTabs: "تب‌های بیشتر داشبورد",
    ...
    actionInProgress: "یک تغییر دیگر داشبورد هنوز در حال ذخیره است.",
    announcement: {
    ...
    widget: {
      ...
      errorDetail: "مشکل به همین کارت محدود است.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "تعویض شاخه به دسترسی مدیر اپراتور نیاز دارد.",
    ...
    board: {
      ...
      dockMenu: "پنجره گفتگو: {dock}",
      dockLeft: "پنجره گفتگو در چپ",
      dockRight: "پنجره گفتگو در راست",
      dockBottom: "پنجره گفتگو در پایین",
      dockHidden: "پنهان کردن گفتگو",
      resizeDock: "تغییر اندازه پنجره گفتگو",
    ...
    messages: {
      ...
      rewind: "بازگرداندن",
      rewindConfirm: "به پیش از این پیام بازگردانده شود؟",
      rewindToHere: "بازگرداندن به اینجا",
      rewindUnavailable: "بازگرداندن هنگام کار کردن عامل در دسترس نیست",
    ...
    toolCards: {
      ...
      widgetActions: "کنش‌های ابزارک",
      copyToClipboard: "کپی در کلیپ‌بورد",
      downloadFile: "دانلود فایل",
      widgetExportRerender: "برای خروجی گرفتن به‌صورت تصویر، این ابزارک باید دوباره رندر شود.",
      widgetExportFailed: "خروجی گرفتن از ابزارک ناموفق بود. دوباره تلاش کنید.",
