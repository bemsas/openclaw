...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    security: "Gateway kimlik doğrulaması, yürütme ilkesi, araç profili ve onaylar.",
  ...
  mcpServers: {
    ...
    missing: "“{name}” adlı MCP sunucusu yapılandırmada bulunamadı.",
  ...
  mcpPage: {
    connectorsLink: "Eklentiler sayfasında tek tıklamayla bağlanan konnektörleri keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    intro:
      "Labs, sürümler arasında değişebilecek, bozulabilecek veya kaldırılabilecek deneysel yetenekler içerir.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Bileğinizden hızlı bakışta sohbetler ve hızlı yanıtlar.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Gateway için menü çubuğu yardımcısı — bildirimler, onaylar, hızlı sohbet.",
      },
      windows: {
        title: "Windows",
  ...
  board: {
    ...
    widget: {
      ...
      errorDetail: "Sorun yalnızca bu kartla sınırlı.",
