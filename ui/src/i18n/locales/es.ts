...
export const es: TranslationMap = {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelAuth: "Autenticación de {channel} degradada — pregúntame qué pasó",
  ...
  labsPage: {
    intro:
      "Labs contiene capacidades experimentales que pueden cambiar, romperse o desaparecer entre versiones.",
    ...
    swarm: {
      title: "Swarm",
      description: "Deja que Code Mode orqueste grupos de subagentes en paralelo.",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    ...
    cards: {
      ...
      linux: {
        title: "Linux",
        desc: "Aplicación nativa de escritorio: compilaciones .deb y AppImage.",
      },
      chrome: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget del panel: {title}. Usa las teclas de flecha para navegar. Mantén pulsada Alt y presiona una tecla de flecha para moverlo.",
      ...
      actionErrorDetail: "El panel conservó el estado anterior del widget.",
