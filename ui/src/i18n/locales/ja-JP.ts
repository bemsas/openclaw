...
export const ja_JP: TranslationMap = {
  ...
  subtitles: {
    ...
    apps: "スマートフォン、時計、デスクトップ、ブラウザ用のコンパニオンアプリ。",
    ...
    notifications: "ゲートウェイからのブラウザプッシュ通知。",
    security: "Gateway の認証、実行ポリシー、ツールプロファイル、承認。",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} が劣化しています — 何が起きたか私に尋ねてください",
  ...
  mcpPage: {
    connectorsLink: "Plugins ページでワンクリックコネクタを探せます。",
    servers: "サーバー",
    oauth: "OAuth",
    filtered: "フィルター済み",
  ...
  labsPage: {
    intro:
      "Labs にはリリース間で変更、破損、または削除される可能性のある実験的な機能が含まれています。",
    sectionTitle: "実験的な機能",
    ...
    swarm: {
      title: "Swarm",
      description:
        "Code Mode がサブエージェントのグループを並列でオーケストレーションできるようにします。",
    },
  },
  aboutPage: {
  ...
  board: {
    ...
    widget: {
      ...
      frameResolverMissing: "ウィジェットコンテンツを利用できません。",
  ...
  chat: {
    ...
    messages: {
      ...
      rewind: "巻き戻し",
      rewindConfirm: "このメッセージの前に巻き戻しますか？",
