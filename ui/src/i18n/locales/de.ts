...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    advanced: "Alle übrigen Konfigurationsabschnitte sowie der Editor für die Rohdatei.",
  ...
  mcpPage: {
    connectorsLink: "Entdecke Ein-Klick-Konnektoren auf der Seite Plugins.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description: "Lass Agenten Tools in kompakten, isolierten JavaScript-Workflows kombinieren.",
    },
    swarm: {
      title: "Swarm",
      description: "Lass Code Mode Gruppen von Subagenten parallel orchestrieren.",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    heroTitle: "Nimm OpenClaw überallhin mit",
    heroTagline:
      "Begleit-Apps für dein Smartphone, deine Uhr, deinen Desktop und deinen Browser – plus Plugins, um die Fähigkeiten deines Agenten zu erweitern.",
    sectionMobile: "Auf deinem Smartphone",
    havePhone: "Du hast die App bereits?",
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Der Android-Begleiter erweitert OpenClaw auf Ihre Uhr.",
      },
      macos: {
        title: "macOS",
        desc: "Menüleisten-Begleiter für Ihr Gateway – Benachrichtigungen, Freigaben, schneller Chat.",
      },
      windows: {
        title: "Windows",
        desc: "Der Windows-Begleiter verbindet Ihren PC als OpenClaw-Node.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Lassen Sie OpenClaw Ihr bestehendes Chrome steuern – Tabs, Seiten und Formulare.",
      },
      plugins: {
  ...
  board: {
    ...
    emptyHint: "Ihr Agent kann hier Widgets anheften – fragen Sie nach einer Statuskarte.",
    ...
    announcement: {
      ...
      resized: "{title} in der Größe geändert.",
  ...
  chat: {
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Änderungen werden übernommen, wenn du deine nächste Talk-Sitzung startest.",
