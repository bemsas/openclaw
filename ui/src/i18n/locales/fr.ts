...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    security: "Authentification Gateway, politique d'exécution, profil d'outil et approbations.",
  ...
  sessionsPage: {
    hubTablistLabel: "Sections de fils de discussion",
  },
  pluginsPage: {
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Conversations en un coup d'œil et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  chat: {
    ...
    board: {
      ...
      dockMenu: "Panneau de discussion : {dock}",
      ...
      resizeDock: "Redimensionner le panneau de discussion",
      reopenChat: "Afficher la discussion",
      mockPlaceholder: "Jointure vue tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
      mockResearch: "Recherche",
      mockSessionStatus: "État du fil",
      mockRecentFindings: "Découvertes récentes",
    ...
    questions: {
      ...
      submitting: "Envoi…",
      submitFailed: "Envoi impossible : {error}",
      answered: "Réponse reçue",
