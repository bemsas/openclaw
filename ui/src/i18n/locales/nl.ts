...
export const nl: TranslationMap = {
  ...
  subtitles: {
    ...
    notifications: "Browser-pushmeldingen vanaf je gateway.",
    security: "Gateway-authenticatie, exec-beleid, toolprofiel en goedkeuringen.",
    advanced: "Elke resterende configuratiesectie, plus de ruwe bestandseditor.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin:
        "Voor het wisselen van vertakkingen is operator-adminrechten vereist.",
    ...
    messages: {
      ...
      forkUnavailable: "Vorken is niet beschikbaar terwijl de agent werkt",
    ...
    composer: {
      ...
      cameraInput: "Camera",
      cameraListUnsupported: "Deze browser kan camera's niet weergeven.",
      cameraNoneFound: "Geen camera gevonden.",
      cameraPageInactive: "Camera's zijn niet beschikbaar wanneer deze pagina inactief is.",
